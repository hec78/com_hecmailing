...
<form action="<?php echo JRoute::_('index.php?option=com_hecmailing&view=param'); ?>" method="post" name="adminForm"  id="adminForm">
				...
				<tr valign="top"><td>
				     <fieldset>
				       ...
				       <table class="admintable">
				       	...
				       	<?php if ($latestProd > $ver)  {     ?>
				            <tr><td class="key"><label for="name"><?php echo JText::_( 'COM_HECMAILING_LATEST_PROD_VERSION' ); ?>:</label></td>
				                <td><?php echo $latestProd; ?><a href="index.php?option=com_hecmailing&task=param.upgrade" style="color:red"><?php echo JText::_( 'COM_HECMAILING_UPGRADE_COMPONENT' ); ?></a></td>
				            </tr>
 				       <?php  }  else {    ?>
				            <tr><td class="key"><label for="name"><?php echo JText::_( 'COM_HECMAILING_LATEST_PROD_VERSION' ); ?>:</label></td>
				          ...
				          {     ?>
								<tr><td class="key"><label for="name"><?php echo JText::_( 'COM_HECMAILING_LATEST_TEST_VERSION' ); ?>:</label></td>
				                       <td><?php echo $latestTest; ?>
				                        <a href="index.php?option=com_hecmailing&task=param.upgradetest" style="color:red"><?php echo JText::_( 'COM_HECMAILING_UPGRADE_COMPONENT' ); ?></a></td>
				                </tr>
						<?php }  else {  ?>
				                <tr><td class="key"><label for="name"><?php echo JText::_( 'COM_HECMAILING_LATEST_TEST_VERSION' ); ?>:</label></td>
