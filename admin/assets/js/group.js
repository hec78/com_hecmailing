...
function addUser()
{
	jQuery( "#dialogUser" ).dialog("close");
...
function addMail()
{
	jQuery( "#dialogMail" ).dialog("close");
...
function deleteRows() {  
	try {  
		jQuery( "#dialogDelEntry" ).dialog("close");
...
{
	jQuery( "#dialogUserPerm" ).dialog("close");
...
{
	jQuery( "#dialogGroupPerm" ).dialog("close");
...
function deleteRowsPerm() {  
	try {  
        jQuery( "#dialogDelPerm" ).dialog("close");
